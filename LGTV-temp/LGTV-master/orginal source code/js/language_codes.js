...
temps.map(function (item) {
    var key;
    if(typeof item['iso6391']!="undefined"){
        key=item['iso6391'];
        language_codes[key]=item.name;
    }
    if(typeof item['iso6392B']!="undefined"){
        key=item['iso6392B'];
        language_codes[key]=item.name;
    }
    if(typeof item['iso6392T']!="undefined"){
        key=item['iso6392T'];
        language_codes[key]=item.name;
    }
})
language_codes['tu']="Turkish";