(function ($, doc, win) {
    ...
    var Photobox, photobox, options, images = [], imageLinks, activeImage = -1, activeURL, lastActive, activeType,
        ...
        isTouchDevice = true, // assume "false" unless there's a touch
    ...
    Photobox.prototype = {
        ...
        init: function () {
            ...
            this.thumbsList = thumbsStripe.generate.apply(this);  // This is added by BaiMaoLi, generate thumb list without touch event
        },
