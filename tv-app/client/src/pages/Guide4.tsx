  ...
  return (
    <Link href="/discover-no-user">
      <div className="relative w-[1920px] h-[1080px] bg-white overflow-hidden cursor-pointer" data-testid="page-guide-4">
        ...
        <div className="absolute left-[62px] top-[565px] w-[98px] h-[98px] bg-[rgba(255,255,255,0.2)] rounded-[10px] overflow-clip z-10" data-testid="button-favorites">
          <div className="absolute left-[11px] top-[19px] w-[77px] h-[61px]">
            <p className="absolute left-[38.5px] top-[40px] -translate-x-1/2 font-['Ubuntu',Helvetica] font-medium text-[18px] text-center text-white leading-normal">
              Favorites
            </p>
        ...
        <div className="absolute left-[188px] top-[596px] flex items-center justify-center z-10">
        ...
        {/* Tooltip Box */}
        <div className="absolute left-[340px] top-[555px] w-[597px] h-[115px] bg-black rounded-[10px] overflow-clip z-10">
