 ...
 * Design from Figma: https://www.figma.com/design/SdteT1OO7A2xSkvmIQABCF/Mega-Radio?node-id=2159-7904
 */
    ...
    render: function() {
        var html = `
            <div style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; width: 1920px; height: 1080px; overflow: hidden; background: #ffffff; cursor: pointer;" 
                ...
                <div style="position: absolute; height: 1897px; left: 0; top: 0; width: 1920px;">
                    <div style="position: absolute; top: 0; right: 0; bottom: 0; left: 0; pointer-events: none;">
                        <img alt="" 
                             ...
                             src="${Utils.assetPath('images/discover-nouser-4.png')}">
                        <div style="position: absolute; background: rgba(0,0,0,0.7); top: 0; right: 0; bottom: 0; left: 0;"></div>
                    </div>
                </div>

                <!-- Highlighted Favorites Button -->
                <div style="position: absolute; background: rgba(255,255,255,0.2); left: 62px; overflow: hidden; border-radius: 10px; width: 98px; height: 98px; top: 565px;">
                        ...
                        <div style="position: absolute; left: 23px; width: 32px; height: 32px; top: 0;">
                            <div style="position: absolute; left: 0; width: 32px; height: 32px; top: 0;">
                                <img alt="" 
                                     ...
                                     src="${Utils.assetPath('images/heart-icon-guide.png')}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="position: absolute; display: flex; align-items: center; justify-content: center; left: 188px; top: 596px;">
                    <div style="transform: rotate(1.292deg);">
                        <div style="height: 31.65px; position: relative; width: 130.979px;">
                            <img alt="" 
                                 style="display: block; max-width: none; width: 100%; height: 100%;" 
                                 src="${Utils.assetPath('images/arrow-guide4.svg')}">
                        </div>
                    </div>
                </div>

                <!-- Tooltip Box -->
                <div style="position: absolute; background: #000000; height: 115px; left: 340px; overflow: hidden; border-radius: 10px; top: 555px; width: 597px;">
                    <div style="position: absolute; font-family: 'Ubuntu', Helvetica; font-weight: 500; line-height: normal; left: 67px; font-style: normal; font-size: 24px; color: #ffffff; top: 29px; white-space: nowrap;">
                        <p style="margin-bottom: 0;" data-i18n="guide_favorites_line1">Your favorite radios will be here.</p>
                        <p style="margin-bottom: 0;" data-i18n="guide_favorites_line2">Press yellow on the remote.</p>
                    </div>
