  ...
  return (
    <Link href="/guide-2">
      <div className="relative w-[1920px] h-[1080px] bg-white overflow-hidden cursor-pointer" data-testid="page-guide-1">
        ...
        <div className="absolute left-[64px] top-[242px] w-[98px] h-[98px] bg-[rgba(255,255,255,0.2)] rounded-[10px] overflow-clip" data-testid="button-discover">
        ...
        <div className="absolute left-[188px] top-[274px] flex items-center justify-center">
        ...
        {/* Tooltip Box */}
        <div className="absolute left-[340px] top-[233px] w-[720px] h-[115px] bg-black rounded-[10px] overflow-clip">
