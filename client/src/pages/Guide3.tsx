...
export const Guide3 = (): JSX.Element => {
  return (
    <Link href="/guide-4">
      ...
      <div className="absolute left-[188px] top-[345px] w-[131px] h-[32px] rotate-[1.292deg]">
        <img
      ...
      {/* Tooltip Box */}
      <div className="absolute left-[340px] top-[304px] w-[597px] h-[115px] bg-black rounded-[10px] overflow-clip">
        <p className="absolute left-[67px] top-[43px] font-['Ubuntu',Helvetica] font-medium text-[24px] text-white leading-normal">
          You can press blue to access search.
        </p>
        <div className="absolute left-[24px] top-[48px] w-[18.667px] h-[18.667px] bg-[#4e9cf4] rounded-[40px]" />
      </div>

      {/* Highlighted Search Button */}
      <div className="absolute left-[62px] top-[314px] w-[98px] h-[98px] bg-[rgba(255,255,255,0.2)] rounded-[10px] overflow-clip" data-testid="button-search">
