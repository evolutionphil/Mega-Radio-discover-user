  ...
  return (
    <div className="fixed h-[638px] left-[64px] top-[242px] w-[98px] z-50 pointer-events-auto">
      ...
      <Link href="/discover-no-user">
        <div className={`absolute left-0 overflow-clip rounded-[10px] size-[98px] top-0 ${activePage === 'discover' ? 'bg-[rgba(255,255,255,0.2)]' : ''} ${getFocusClasses(isFocused(0))}`} data-testid="button-discover">
      ...
      {/* Genres */}
      <Link href="/genres">
        <div className={`absolute left-0 overflow-clip rounded-[10px] size-[98px] top-[108px] ${activePage === 'genres' ? 'bg-[rgba(255,255,255,0.2)]' : ''} ${getFocusClasses(isFocused(1))}`} data-testid="button-genres">
      ...
      {/* Search */}
      <Link href="/search">
        <div className={`absolute left-0 overflow-clip rounded-[10px] size-[98px] top-[216px] ${activePage === 'search' ? 'bg-[rgba(255,255,255,0.2)]' : ''} ${getFocusClasses(isFocused(2))}`} data-testid="button-search">
      ...
      {/* Favorites */}
      <Link href="/favorites">
        <div className={`absolute left-0 overflow-clip rounded-[10px] size-[98px] top-[324px] ${activePage === 'favorites' ? 'bg-[rgba(255,255,255,0.2)]' : ''} ${getFocusClasses(isFocused(3))}`} data-testid="button-favorites">
      ...
      {/* Settings */}
      <Link href="/settings">
        <div className={`absolute left-0 overflow-clip rounded-[10px] size-[98px] top-[432px] ${activePage === 'settings' ? 'bg-[rgba(255,255,255,0.2)]' : ''} ${getFocusClasses(isFocused(4))}`} data-testid="button-settings">
